...
def stickler_for_the_rules(agent):
    ...
    # 마지막 좌표는 getp값 말고 고정, min max는 xyz 다 대소관계 중요
    forbidden_room_max_points = {'bedroom_search': [10.0994, 3.5477, 2.0]}
    forbidden_room_min_points = {'bedroom_search': [6.1402, 1.1711, 0.03]}
