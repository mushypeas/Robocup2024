...
def serve_breakfast(agent: Agent):
    ...
    bowl_to_spam_spill_xy = [0.1, 0.05]  # bowl to cereal
    ...
    while True:
        ...
        if item == 'bowl':
            ...
            agent.pose.arm_lift_up(0.485)
            agent.grasp()
            agent.pose.arm_lift_up(0.7)
